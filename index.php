               ...
               <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6">
                         <div class="about-info">
                              ...
                              <p>At 360IrrigationHub, we’ve built our reputation on a simple, non-negotiable fact: Modern irrigation is an electrical system.
You can’t have one without the other. Yet, most property owners are forced to hire a plumber for their pipes and an electrician for their wires, praying the two systems work together.
We eliminate that risk.</p>
                              <p>We are a single, expert team of specialists in both fields. We don't just lay pipe. We don't just run wire. We design, install, and service fully integrated electrical and irrigation solutions. This 360-degree approach is not a gimmick—it's the only way to guarantee your systems are safe, efficient, and reliable.</p>
                         </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                         <div class="about-info skill-thumb">
                              ...
                              <div class="progress">
                                   <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="97"
                              ...
                              <strong>Greenhouse Damliners</strong>
                              ...
                              <div class="progress">
                                   <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="94"
                    ...
                    <div class="col-md-4 col-sm-12">
                         <div class="about-image">
                              <img src="images/drip-image.jpg" class="img-responsive" alt="">
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                         ...
                         <div class="work-thumb">
                              <a href="images/damliner.jpg" class="image-popup">
                                   <img src="images/damliner.jpg" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="images/waterpump.jpg" class="image-popup">
                                   <img src="images/waterpump.jpg" class="img-responsive" alt="Work">

                                   <div class="work-info">
                                        <h3>WaterPump Machine</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="images/borehole.jpg" class="image-popup">
                                   <img src="images/borehole.jpg" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="images/greenhouse.jpg" class="image-popup">
                                   <img src="images/greenhouse.jpg" class="img-responsive" alt="Work">
               ...
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                         ...
                         <form id="contact-form" action="send-mail" enctype="multipart/form-data" role="form" method="post">
                              ...
                              <div class="col-md-6 col-sm-6">
                                   <input type="email" class="form-control" placeholder="Email" id="cf-email"
                                        name="cf-email" required="">
                              </div>

                              <div class="col-md-6 col-sm-6">
                                   <input type="tel" class="form-control" placeholder="Phone" id="cf-number"
               ...
               <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12">
                         <div class="footer-thumb footer-info">
                              <img src="images/removebg.png" class="img-responsive" alt="">
                              <h2>360 Electrical & Irrigation Hub</h2>
                              <p>From high-capacity pump panels to automated outdoor lighting and smart home integration, we provide the flawless, future-proof electrical foundation your modern landscape requires.</p>
                         </div>
                    </div>
                         ...
                         <div class="footer-bottom">
                              ...
                              <div class="col-md-6 col-sm-7">
                                   <div class="phone-contact">
                                        <p>Call us <span>+254 725 231 090</span></p>
                                   </div>
